...
// import * as utils from 'bignumber.js';
...
export default function ReadContract() {
    ...
    const address = "0x5A6034D4B34FbaA937F1E5d4A8Ea8820A683D2e9";

  const { data:balance, error:supplyError } = useReadContract({
    abi,
    address,
    functionName: "totalSupply",
    // args: ['0x6bE76e3D11F388720884dfBA16e5dE31475F8B25'],
  });
  ...
  if (supplyError) {
    console.error("Error fetching balance:", supplyError);
  }
  if (symbolError) {
    console.error("Error fetching balance:", symbolError);
  }

  return (
    <>
    {/* <div>Balance: {balance?.toString()}</div>; */}
    <div>BAlance: {balance? convert(balance, 'wei', 'ether') : "Not Fetched Yet"} {symbolData}</div>
