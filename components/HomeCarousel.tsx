  ...
  return (
    ...
    <Swiper
      ...
      >
        {slides.map((slide)=>(
            <SwiperSlide >
            <div className='h-auto text-left rounded-tr-3xl rounded-lg border border-Cpurple bg-transparent '>
                <div className='p-4'>
                    ...
                    <div className='flex justify-between my-5'>
                        ...
                        <button className='text-sm'>{slide.button}</button>
                    </div>
                </div>
            </div>
            </SwiperSlide>
...
return (
  ...
  <Swiper
    ...
    >
      {slides.map((slide)=>(
          <SwiperSlide >
          <div className='h-auto rounded-2xl border border-gray-500 p-5'>
